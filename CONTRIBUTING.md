...
`HARMAN-Automotive/nosql-dao` up to date and always improving! There are a few guidelines that we need
contributors to follow to keep the project consistent, as well as allow us to keep
maintaining `HARMAN-Automotive/nosql-dao` in a reasonable amount of time.
...
1. Please make sure there is no [open issue](https://github.com/HARMAN-Automotive/nosql-dao/issues) yet.
...
- Submit a pull request from your topic branch to the [main](https://github.com/HARMAN-Automotive/nosql-dao) branch on the `HARMAN-Automotive/nosql-dao` repository.
...
- Ensure that the PR is tagged with related [issue](https://github.com/HARMAN-Automotive/nosql-dao/issues) it intends to resolve.
